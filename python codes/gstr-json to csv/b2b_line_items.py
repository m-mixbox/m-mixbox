...
#r'D:\xampp\htdocs\scripts\json to csv\returns_26082023_R1_20AAGCT5841D1ZQ_offline_others_0.json'
...
#print(df)
#with pd.ExcelWriter(r"D:\data.xlsx") as writer:
   
    # use to_excel function and specify the sheet_name and index 
    # to store the dataframe in specified sheet
    #df.to_excel(writer, sheet_name="b2b line items", columns=header)
def fun () :
   return df